...
// that a metric suffix (K/M/B/T) rendered to 3 significant figures — e.g.
// 1,234,567 -> "1.23M", 12,345 -> "12.3K", 123,456 -> "123K". Shared between
// the desktop renderer (race view) and main process (tray title).
