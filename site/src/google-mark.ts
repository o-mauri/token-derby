// Google's official four-colour "G" mark, 18x18, per the "Sign in with Google"
// branding spec. Inline SVG so the button needs no third-party image request.

export function googleMarkSvg(): string {
  return (
    '<svg class="google-mark" viewBox="0 0 18 18" width="18" height="18" aria-hidden="true">' +
