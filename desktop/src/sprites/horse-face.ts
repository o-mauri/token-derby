// Ported unchanged from site/src/horse-face.ts — a small pixel horse head,
// cropped from the in-race sprite (cols 24-31, rows 2-7), returned as inline
// SVG markup so it can be dropped into innerHTML templates.
