// Ported unchanged from site/src/time.ts — pure duration/countdown formatting,
// no browser coupling. See position.ts for why this is a copy rather than an
// import (it lives outside @token-derby/shared).
