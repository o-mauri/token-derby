// Ported from site/src/render/reconcile.ts — pure DOM reconciliation, no
// browser/network coupling. Only the sprite-building imports changed: desktop
// already has its own copies of sprite-svg.ts/hat-svg.ts (ported in an earlier
// task) under ../sprites/, so this reuses those instead of duplicating them.
...
import { buildHorseSvg } from '../sprites/sprite-svg.js';
import { buildHatGroup } from '../sprites/hat-svg.js';
